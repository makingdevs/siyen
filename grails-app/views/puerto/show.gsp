...
<html>
  ...
  <body>
    ...
    <div id="show-puerto" class="content scaffold-show" role="main">
      ...
      <g:form url="[resource:puertoInstance, action:'delete']" method="DELETE">
        <fieldset class="buttons">
          <g:link class="edit" action="edit" resource="${puertoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
