...
set AGENT_STRING=-javaagent:grailsWrapper/springloaded-core-1.1.3.jar -noverify -Dspringloaded.synchronize=true -Djdk.reflect.allowGetCallerClass=true -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=grailsWrapper/grails-wrapper-runtime-2.2.3.jar;grailsWrapper;.
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.2.3
